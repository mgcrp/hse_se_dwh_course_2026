## Демо 5. MPP на примере GreenPlum
...
- Клонируем https://github.com/yuan-fei/TPCH-Greenplum (или мой [форк](https://github.com/mgcrp/TPCH-Greenplum), в котором уже все настроено и работает)
